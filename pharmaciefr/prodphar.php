<?php
  if(isset($_POST['btn-ajouter'])){
      ...
      if(!empty($titre) && !empty($description)){
          ...
          $req1 = mysqli_query($con, "SELECT titre ,descrip FROM phar WHERE titre ='$titre' AND descrip = '$description'");
          if(mysqli_num_rows($req1) > 0) {
              ...
              if(isset($_FILES['image'])){
                  ...
                  if($deplacer_image){
                      ...
                      $req2 = mysqli_query($con,"INSERT INTO phar VALUES ('','$titre','$description','$nouveau_nom_img')") ;
                       if($req2){
...
<head>
    ...
    <link rel="stylesheet" href="ajouterprod.css">
</head>
<body>
    <section class="input_add">
        <form action="" method="POST" enctype="multipart/form-data">
           ...
           <?php 
            ...
            <a class="btn-liste-prod" href="medicine.php"> Liste des produits</a>
        </form>
    </section>
</body>
</html>